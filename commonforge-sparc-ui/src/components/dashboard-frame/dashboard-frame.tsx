...
export function DashboardFrame({
  ...
  return (
    <section
      ...
      className={cn("flex min-h-[146.5625rem] w-full items-start bg-background p-2", className)}
    >
      <div
        data-node-id="2533:3619"
        className={cn(
          "relative flex min-h-[145.5625rem] min-w-0 flex-1 flex-col overflow-hidden rounded-[0.5rem] bg-surface ring-[0.5px] ring-black/10",
      ...
      >
        ...
        >
          <div
            data-node-id="2533:3621"
            data-name="Breadcrumb"
            className="flex items-center gap-3.5"
          >
            <p className="text-xs leading-4 font-normal text-black">{breadcrumb}</p>
          </div>
        </header>
        <div data-node-id="2533:3622" className="relative z-10 min-h-[143.3125rem] w-full">
          {children}
        </div>
      </div>
    </section>
